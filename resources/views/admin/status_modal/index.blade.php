...
@section('content')
                ...
                <div class="card-body">
                    ...
                    <form id="createUserForm">
                        <div class="my-3">
                            ...
                            <input type="text" name="status_modal" id="createStatusModal" class="form-control" autofocus>
                        </div>
    ...
    @include('admin.status_modal.components.modal')
@endsection
@include('admin.status_modal.script')
