...
@section('content')
                ...
                <div class="card-body">
                    ...
                    <form id="createUserForm">
                        <div class="my-3">
                            ...
                            <input type="text" name="kategori" id="createKategori" class="form-control" autofocus>
                        </div>
    ...
    @include('admin.berita.kategori.components.modal')
@endsection
@include('admin.berita.kategori.script')
