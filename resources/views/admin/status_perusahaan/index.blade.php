...
@section('content')
                ...
                <div class="card-body">
                    ...
                    <form id="createUserForm">
                        <div class="my-3">
                            ...
                            <input type="text" name="status" id="createStatus" class="form-control" autofocus>
                        </div>
    ...
    @include('admin.status_perusahaan.components.modal')
@endsection
@include('admin.status_perusahaan.script')
