...
@section('content')
                ...
                <div class="card-body">
                    ...
                    <form id="createUserForm">
                        <div class="my-3">
                            ...
                            <input type="text" name="kepemilikan" id="createKepemilikan" class="form-control" autofocus>
                        </div>
    ...
    @include('admin.kepemilikan_perusahaan.components.modal')
@endsection
@include('admin.kepemilikan_perusahaan.script')
